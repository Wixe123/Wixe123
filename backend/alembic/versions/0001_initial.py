...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("primary_color", sa.String(), server_default="#7C3AED"),
        sa.Column("accent_color", sa.String(), server_default="#22D3EE"),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.String(), primary_key=True),
        sa.Column("user_id", sa.String(), sa.ForeignKey("users.id"), unique=True, nullable=False),
        sa.Column("subtitle_font", sa.String(), server_default="Montserrat"),
        sa.Column("subtitle_color", sa.String(), server_default="#FFFFFF"),
        sa.Column("subtitle_highlight_color", sa.String(), server_default="#22D3EE"),
